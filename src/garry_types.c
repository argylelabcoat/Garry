...
const char *garry_strerror(garry_status_t status)
{
    ...
    case GARRY_OK:
        return "ok";
    case GARRY_ERR_NOT_FOUND:
        return "not found";
    case GARRY_ERR_LOCK_CONFLICT:
        return "lock conflict";
    case GARRY_ERR_IO:
        return "i/o error";
    case GARRY_ERR_CORRUPT:
        return "corrupt database";
    case GARRY_ERR_INVALID_ARG:
        return "invalid argument";
    case GARRY_ERR_NOMEM:
        return "out of memory";
    case GARRY_ERR_BUFFER_TOO_SMALL:
